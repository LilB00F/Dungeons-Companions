...
public class GarnetBlockBlock extends DungeonsAndCompanionsModElements.ModElement {
	@ObjectHolder("dungeons_and_companions:garnet_block")
	public static final Block block = null;
	public GarnetBlockBlock(DungeonsAndCompanionsModElements instance) {
		super(instance, 86);
	}
