...
import net.mcreator.dungeonsandcompanions.item.OnyxItem;
...
public class OnyxOreBlock extends DungeonsAndCompanionsModElements.ModElement {
	@ObjectHolder("dungeons_and_companions:onyx_ore")
	public static final Block block = null;
	public OnyxOreBlock(DungeonsAndCompanionsModElements instance) {
		super(instance, 161);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(OnyxItem.block, (int) (1)));
		}
	}
	@Override
