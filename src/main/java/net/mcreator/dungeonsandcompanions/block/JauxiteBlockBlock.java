...
public class JauxiteBlockBlock extends DungeonsAndCompanionsModElements.ModElement {
	@ObjectHolder("dungeons_and_companions:jauxite_block")
	public static final Block block = null;
	public JauxiteBlockBlock(DungeonsAndCompanionsModElements instance) {
		super(instance, 80);
	}
