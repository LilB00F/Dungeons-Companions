...
public class JauxiteOreBlock extends DungeonsAndCompanionsModElements.ModElement {
	@ObjectHolder("dungeons_and_companions:jauxite_ore")
	public static final Block block = null;
	public JauxiteOreBlock(DungeonsAndCompanionsModElements instance) {
		super(instance, 155);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("jauxite_ore", "jauxite_ore", blockAt -> {
