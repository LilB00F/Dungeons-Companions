...
public class DuristeelBlockBlock extends DungeonsAndCompanionsModElements.ModElement {
	@ObjectHolder("dungeons_and_companions:duristeel_block")
	public static final Block block = null;
	public DuristeelBlockBlock(DungeonsAndCompanionsModElements instance) {
		super(instance, 116);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("duristeel_block");
		}
