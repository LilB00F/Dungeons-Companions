...
public class CalamiteBlockBlock extends DungeonsAndCompanionsModElements.ModElement {
	@ObjectHolder("dungeons_and_companions:calamite_block")
	public static final Block block = null;
	public CalamiteBlockBlock(DungeonsAndCompanionsModElements instance) {
		super(instance, 122);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("calamite_block");
		}
