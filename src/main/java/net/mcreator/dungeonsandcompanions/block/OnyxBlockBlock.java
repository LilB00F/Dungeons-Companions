...
public class OnyxBlockBlock extends DungeonsAndCompanionsModElements.ModElement {
	@ObjectHolder("dungeons_and_companions:onyx_block")
	public static final Block block = null;
	public OnyxBlockBlock(DungeonsAndCompanionsModElements instance) {
		super(instance, 110);
	}
