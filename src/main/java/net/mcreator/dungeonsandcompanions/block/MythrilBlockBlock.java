...
public class MythrilBlockBlock extends DungeonsAndCompanionsModElements.ModElement {
	@ObjectHolder("dungeons_and_companions:mythril_block")
	public static final Block block = null;
	public MythrilBlockBlock(DungeonsAndCompanionsModElements instance) {
		super(instance, 128);
	}
