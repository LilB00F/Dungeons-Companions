...
import net.mcreator.dungeonsandcompanions.item.CompositebowItem;
...
public class CompanionNolatiEntity extends DungeonsAndCompanionsModElements.ModElement {
	public static EntityType entity = null;
	@ObjectHolder("dungeons_and_companions:entitybulletcompanion_nolati")
	public static final EntityType arrow = null;
	public CompanionNolatiEntity(DungeonsAndCompanionsModElements instance) {
		super(instance, 27);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(72).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("companion_nolati")
						.setRegistryName("companion_nolati");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -981761, new Item.Properties().group(CreativeCompanionModtabItemGroup.tab))
				.setRegistryName("companion_nolati_spawn_egg"));
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
				.size(0.5f, 0.5f)).build("entitybulletcompanion_nolati").setRegistryName("entitybulletcompanion_nolati"));
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("dungeons_and_companions:textures/medieval_girl.png");
				}
			};
	...
	public static class CustomEntity extends TameableEntity implements IRangedAttackMob {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 10;
			setNoAI(false);
			setCustomName(new StringTextComponent("Notali"));
			setCustomNameVisible(true);
			enablePersistence();
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(CompositebowItem.block, (int) (1)));
		}
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(5, new LookAtGoal(this, ServerPlayerEntity.class, (float) 6));
			this.goalSelector.addGoal(6, new RandomWalkingGoal(this, 0.8));
			this.targetSelector.addGoal(7, new NearestAttackableTargetGoal(this, MonsterEntity.class, true, true));
			...
			if (sourceentity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) sourceentity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent(" Notali");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new CompanionNolatiguiGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
	...
	private static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(Items.GRAY_DYE, (int) (1));
		}
