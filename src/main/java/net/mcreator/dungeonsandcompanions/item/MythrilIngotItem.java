...
public class MythrilIngotItem extends DungeonsAndCompanionsModElements.ModElement {
	@ObjectHolder("dungeons_and_companions:mythril_ingot")
	public static final Item block = null;
	public MythrilIngotItem(DungeonsAndCompanionsModElements instance) {
		super(instance, 126);
	}
