...
import net.mcreator.dungeonsandcompanions.procedures.IronSpearRangedItemUsedProcedure;
...
public class IronSpearItem extends DungeonsAndCompanionsModElements.ModElement {
	@ObjectHolder("dungeons_and_companions:iron_spear")
	public static final Item block = null;
	@ObjectHolder("dungeons_and_companions:entitybulletiron_spear")
	public static final EntityType arrow = null;
	public IronSpearItem(DungeonsAndCompanionsModElements instance) {
		super(instance, 44);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletiron_spear").setRegistryName("entitybulletiron_spear"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(CreativeCompanionModtabItemGroup.tab).maxDamage(500));
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 1f, 6.5, 1);
					itemstack.damageItem(1, entity, e -> e.sendBreakAnimation(entity.getActiveHand()));
					entityarrow.pickupStatus = AbstractArrowEntity.PickupStatus.DISALLOWED;
					{
						Map<String, Object> $_dependencies = new HashMap<>();
						$_dependencies.put("itemstack", itemstack);
						IronSpearRangedItemUsedProcedure.executeProcedure($_dependencies);
					}
				}
			}
		}
	...
	public static class CustomRender extends EntityRenderer<ArrowCustomEntity> {
		private static final ResourceLocation texture = new ResourceLocation("dungeons_and_companions:textures/ironspeartex.png");
		...
		public void render(ArrowCustomEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn,
			...
			EntityModel model = new Modelspearmodel();
