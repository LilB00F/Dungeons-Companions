...
public class MythrilArmorItem extends DungeonsAndCompanionsModElements.ModElement {
	@ObjectHolder("dungeons_and_companions:mythril_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("dungeons_and_companions:mythril_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("dungeons_and_companions:mythril_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("dungeons_and_companions:mythril_armor_boots")
	public static final Item boots = null;
	public MythrilArmorItem(DungeonsAndCompanionsModElements instance) {
		super(instance, 149);
	}
		...
		elements.items
				.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(CreativeCompanionModtabItemGroup.tab)) {
					...
					public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
						return "dungeons_and_companions:textures/models/armor/mythril_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
					}
