...
public class OpalItem extends DungeonsAndCompanionsModElements.ModElement {
	@ObjectHolder("dungeons_and_companions:opal")
	public static final Item block = null;
	public OpalItem(DungeonsAndCompanionsModElements instance) {
		super(instance, 96);
	}
