...
import net.mcreator.dungeonsandcompanions.procedures.DiamondSpearRangedItemUsedProcedure;
...
public class DiamondSpearItem extends DungeonsAndCompanionsModElements.ModElement {
	@ObjectHolder("dungeons_and_companions:diamond_spear")
	public static final Item block = null;
	@ObjectHolder("dungeons_and_companions:entitybulletdiamond_spear")
	public static final EntityType arrow = null;
	public DiamondSpearItem(DungeonsAndCompanionsModElements instance) {
		super(instance, 35);
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(CreativeCompanionModtabItemGroup.tab).maxDamage(1600));
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 1f, 7.5, 1);
					itemstack.damageItem(1, entity, e -> e.sendBreakAnimation(entity.getActiveHand()));
					entityarrow.pickupStatus = AbstractArrowEntity.PickupStatus.DISALLOWED;
					{
						Map<String, Object> $_dependencies = new HashMap<>();
						$_dependencies.put("itemstack", itemstack);
						DiamondSpearRangedItemUsedProcedure.executeProcedure($_dependencies);
					}
				}
			}
		}
	...
	public static class CustomRender extends EntityRenderer<ArrowCustomEntity> {
		private static final ResourceLocation texture = new ResourceLocation("dungeons_and_companions:textures/bulletdiamondspear.png");
