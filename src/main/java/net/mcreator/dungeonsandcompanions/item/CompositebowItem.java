...
public class CompositebowItem extends DungeonsAndCompanionsModElements.ModElement {
	@ObjectHolder("dungeons_and_companions:compositebow")
	public static final Item block = null;
	@ObjectHolder("dungeons_and_companions:entitybulletcompositebow")
	public static final EntityType arrow = null;
	public CompositebowItem(DungeonsAndCompanionsModElements instance) {
		super(instance, 30);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletcompositebow").setRegistryName("entitybulletcompositebow"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(CreativeCompanionModtabItemGroup.tab).maxDamage(450));
			setRegistryName("compositebow");
		}
